...
class Metabolism(models.Model):
    ...
    drug_record = models.ForeignKey(CompoundRecords, models.DO_NOTHING, blank=True, null=True, related_name='CompoundRecords_drug_record')
    substrate_record = models.ForeignKey(CompoundRecords, models.DO_NOTHING, blank=True, null=True, related_name='CompoundRecords_substrate_record')
    metabolite_record = models.ForeignKey(CompoundRecords, models.DO_NOTHING, blank=True, null=True, related_name='CompoundRecord_metabolite_record')
...
class MoleculeHierarchy(models.Model):
    molregno = models.OneToOneField(MoleculeDictionary, models.DO_NOTHING, db_column='molregno', primary_key=True)
    parent_molregno = models.ForeignKey(MoleculeDictionary, models.DO_NOTHING, db_column='parent_molregno', blank=True, null=True, related_name='MoleculeHierarchy_parent_mol')
    active_molregno = models.ForeignKey(MoleculeDictionary, models.DO_NOTHING, db_column='active_molregno', blank=True, null=True, related_name='MoleculeHierarchy_active_mol')
...
class TargetRelations(models.Model):
    tid = models.ForeignKey(TargetDictionary, models.DO_NOTHING, db_column='tid', related_name='TargetRelations_tid')
    relationship = models.CharField(max_length=20)
    related_tid = models.ForeignKey(TargetDictionary, models.DO_NOTHING, db_column='related_tid', related_name='TargetRelations_related_tid')
...
class Humankinase(models.Model):
    kinase_id = models.BigIntegerField(primary_key=True)
    x_name = models.CharField(max_length=50)
    manning_name = models.CharField(max_length=50)
    hgnc_name = models.CharField(max_length=50)
    kinase_name = models.CharField(max_length=200)
    group_name = models.CharField(max_length=50)
    family_name = models.CharField(max_length=50)
    subfamily_name = models.CharField(max_length=50)
    uniprotid = models.CharField(max_length=50)
    chemblid = models.OneToOneField(ChemblIdLookup, models.DO_NOTHING)



class Osrimolecule(models.Model):

   # def create_new_ref_number():
   #     not_unique = True
   #     while not_unique:
   #         unique_ref = random.randint(10000000, 99999999)
   #         if not Osrimolecule.objects.filter(molecule_id=unique_ref):
   #             not_unique = False
   #     return str(unique_ref)

   # molecule_id = models.CharField(max_length=50,blank=True,editable=False,unique=True,primary_key=True,default=ligand_id)
   # ligand_id = models.CharField(max_length=100)
    ligand_id = models.CharField(max_length=50,blank=True,editable=False,unique=True,primary_key=True)
    canonical_smiles = models.CharField(max_length=4000,blank=True, null=True)
    target_id = models.CharField(max_length=200,blank=True, null=True)
    assay_type = models.CharField(max_length=50,blank=True, null=True)
    activity_type = models.CharField(max_length=50,blank=True, null=True)
    activity_unit = models.CharField(max_length=50,blank=True, null=True)
    activity_value = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    logp = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)  
    tpsa = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    recorder = models.CharField(max_length=50,blank=True, null=True) 

    #file_path = settings.STATICFILES_DIRS[0] + '//images/inhouse'
    #file_path = '\\images\inhouse'

    #image = models.FilePathField(path=file_path,blank=True, null=True)
    img_temp = models.ImageField(upload_to='image/inhouse',blank=True, null=True)
    date_published = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    date_modified = models.DateTimeField(auto_now=True,blank=True, null=True) 

    disease = models.CharField(max_length=4000,blank=True, null=True)
    descriptions = models.CharField(max_length=4000,blank=True, null=True)
