# Generated by Django 3.2.5 on 2021-12-29 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
                ...
                ('upper_value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
                ('standard_upper_value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
                ('type', models.CharField(max_length=250)),
                ('relation', models.CharField(blank=True, max_length=50, null=True)),
                ('value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('actsm_id', models.BigIntegerField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('assay_class_id', models.BigIntegerField(primary_key=True, serialize=False)),
                ('l1', models.CharField(blank=True, max_length=100, null=True)),
                ('l2', models.CharField(blank=True, max_length=100, null=True)),
                ('l3', models.CharField(blank=True, max_length=1000, null=True, unique=True)),
                ('class_type', models.CharField(blank=True, max_length=50, null=True)),
                ('bao_id', models.CharField(blank=True, max_length=11, null=True)),
        ...
        migrations.CreateModel(
            name='AssayClassMap',
            fields=[
                ('ass_cls_map_id', models.BigIntegerField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
                ('units', models.CharField(blank=True, max_length=100, null=True)),
                ('text_value', models.CharField(blank=True, max_length=4000, null=True)),
                ('standard_type', models.CharField(blank=True, max_length=250, null=True)),
                ('standard_relation', models.CharField(blank=True, max_length=50, null=True)),
                ('standard_value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
                ('standard_units', models.CharField(blank=True, max_length=100, null=True)),
                ('standard_text_value', models.CharField(blank=True, max_length=4000, null=True)),
                ('comments', models.CharField(blank=True, max_length=4000, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assay_source', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('orig_description', models.CharField(blank=True, max_length=4000, null=True)),
                ('mc_tax_id', models.BigIntegerField(blank=True, null=True)),
                ('mc_organism', models.CharField(blank=True, max_length=100, null=True)),
                ('mc_target_type', models.CharField(blank=True, max_length=28, null=True)),
                ('mc_target_name', models.CharField(blank=True, max_length=4000, null=True)),
                ('mc_target_accession', models.CharField(blank=True, max_length=255, null=True)),
                ('curation_comment', models.CharField(blank=True, max_length=4000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell_ontology_id', models.CharField(blank=True, max_length=10, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('confidence_score', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ddd_value', models.DecimalField(blank=True, decimal_places=30, max_digits=64, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strength', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            name='Osrimolecule',
            fields=[
                ('ligand_id', models.CharField(blank=True, editable=False, max_length=50, primary_key=True, serialize=False, unique=True)),
                ...
                ('assay_type', models.CharField(blank=True, max_length=50, null=True)),
                ('activity_type', models.CharField(blank=True, max_length=50, null=True)),
                ('activity_unit', models.CharField(blank=True, max_length=50, null=True)),
                ('activity_value', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('logp', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('tpsa', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('recorder', models.CharField(blank=True, max_length=50, null=True)),
                ('image', models.FilePathField(blank=True, null=True, path='/home/jxy/myweb/myweb/static\\images\\inhouse')),
                ('img_temp', models.ImageField(blank=True, null=True, upload_to='image/inhouse')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('molregno', models.OneToOneField(db_column='molregno', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='ourdatabase.moleculedictionary')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cx_most_apka', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
                ('cx_most_bpka', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
                ('cx_logp', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
                ('cx_logd', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
        ...
        migrations.CreateModel(
            name='LigandEff',
            fields=[
                ('activity', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='ourdatabase.activities')),
        ...
        migrations.CreateModel(
            name='Humankinase',
            fields=[
                ('kinase_id', models.BigIntegerField(primary_key=True, serialize=False)),
                ...
                ('chemblid', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='ourdatabase.chemblidlookup')),
            ],
        ),
    ]
