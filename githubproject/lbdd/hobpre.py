...
def mordred_calculate(smiles_right):
###
    calc = Calculator(descriptors, ignore_3D=True)
    mols = [Chem.MolFromSmiles(smi) for smi in smiles_right]
    finger = calc.pandas(mols)
    finger.insert(0,'name',smiles_right)
###
    return finger

def load_rfmodel(hobdirs):
    model_rf0 = pickle.load(open(hobdirs+'/hob_rf0.pkl', 'rb'))
    model_rf1 = pickle.load(open(hobdirs+'/hob_rf1.pkl', 'rb'))
    model_rf2 = pickle.load(open(hobdirs+'/hob_rf2.pkl', 'rb'))
    model_rf3 = pickle.load(open(hobdirs+'/hob_rf3.pkl', 'rb'))
    model_rf4 = pickle.load(open(hobdirs+'/hob_rf4.pkl', 'rb'))
    return model_rf0,model_rf1,model_rf2,model_rf3,model_rf4

def hobmodel_predict(smiles_right,hobdirs):
    ...
    pre_data1[pd.isna(pre_data1)] = 0
    model_rf0,model_rf1,model_rf2,model_rf3,model_rf4=load_rfmodel(hobdirs)
